...
import { taoThongBaoLopHP } from '../service/giangvien.service'; 
import { useRecoilValue } from 'recoil';
import { giangVienDataState } from '../state';

const TaoThongBaoLHP = () => {
    ...
    const handleTaoThongBao = async () => {
        ...
        try {
            ...
            const response = await taoThongBaoLopHP({
                tieuDeThongBao,
                noiDungThongBao,
                taoThongBao,
                maLHP,
        ...
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('TaoThongBaoGV')}>
                    <Text style={styles.buttonText}>ĐÁNH GIÁ HỌC TẬP TỪNG SINH VIÊN</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.buttonContainer}>
